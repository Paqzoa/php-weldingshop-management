...
//   echo "<script>" . "window.location.href='admin_onboard.php'" . "</script>";
//   exit;
// }
          ...
          <table >
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><a href='view_order.php?id={$row['order_id']}'>View</a> <hr> <a href='processes/delete-order.php?id={$row['order_id']}'>Delete</a></td>";
                echo "</tr>";
              }
              ?>
            </tbody>
