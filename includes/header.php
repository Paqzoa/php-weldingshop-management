...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="/ArtcoApp/">ARTCO METALS</a>
...
<?php
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="/ArtcoApp/">Home<i class="fa fa-home" style="font-size:15px;color:white"></i></a>
                </li>
                ...
                if (!isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] == !TRUE) {
                    ...
                    <a class="nav-link" href="login.php">Dashboard<i class="fa fa-dashboard" style="font-size:15px;color:white"></i></a>
